...
const HeroSection: React.FC = () => {
    return (
        <section className="relative overflow-hidden bg-gradient-to-r from-blue-800 to-indigo-900 py-20 lg:py-32">
            ...
            <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col items-center justify-between lg:flex-row">
                    ...
                    >
                        <motion.div
                            className="bg-opacity-20 mb-6 inline-block rounded-full bg-blue-400 px-4 py-1 text-sm font-semibold text-blue-100"
                        ...
                        <motion.h1
                            className="mb-8 text-4xl leading-tight font-bold tracking-tight text-white sm:text-5xl lg:text-6xl"
                            initial={{ opacity: 0 }}
                            animate={{ opacity: 1 }}
                        ...
                        >
                            ...
                            <motion.span
                                className="relative ml-3 whitespace-nowrap text-blue-300"
                                initial={{ opacity: 0 }}
                                animate={{ opacity: 1 }}
                                transition={{ delay: 0.9, duration: 0.8 }}
                            >
                                <svg aria-hidden="true" viewBox="0 0 418 42" className="absolute -bottom-3 left-0 h-[0.6em] w-full fill-blue-400/30">
                                    <motion.path
                        ...
                        <motion.p
                            className="mb-10 text-lg leading-relaxed text-blue-100 md:text-xl"
                            initial={{ opacity: 0, y: 20 }}
                            animate={{ opacity: 1, y: 0 }}
                        ...
                        >
                            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                                <Link
                                    href="/map"
                                    className="rounded-lg bg-blue-500 px-6 py-3 font-medium text-white shadow-lg transition-all hover:bg-blue-600 hover:shadow-blue-500/25"
                                >
                                    Lihat Peta Risiko
                                </Link>
                            </motion.div>
                            ...
                            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                                <Link
                                    ...
                                    className="rounded-lg border border-white/30 bg-white/10 px-6 py-3 font-medium text-white backdrop-blur-sm transition-all hover:bg-white/20"
                                >
                                    Laporkan Bencana
                                </Link>
                            </motion.div>
