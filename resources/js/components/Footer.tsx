                ...
                <div className="flex flex-wrap justify-between">
                    ...
                    <div className="mb-8 w-1/2 md:mb-0 md:w-1/6">
                        ...
                        <ul className="space-y-2">
                            <li>
                                <a href="#hero" className="text-gray-600 hover:text-blue-600" onClick={(e) => scrollToSection('hero', e)}>
                                    Beranda
                                </a>
                            </li>
                            <li>
                                <a href="#features" className="text-gray-600 hover:text-blue-600" onClick={(e) => scrollToSection('features', e)}>
                                    Fitur
                                </a>
                            </li>
                            <li>
                                <a href="#users" className="text-gray-600 hover:text-blue-600" onClick={(e) => scrollToSection('users', e)}>
                                    Pengguna
                                </a>
                            </li>
                            <li>
                                <a href="#statistics" className="text-gray-600 hover:text-blue-600" onClick={(e) => scrollToSection('statistics', e)}>
                                    Statistik
                                </a>
                            </li>
                            <li>
                                <a href="#news" className="text-gray-600 hover:text-blue-600" onClick={(e) => scrollToSection('news', e)}>
                                    Berita
                                </a>
                            </li>
                            <li>
                                <a href="#about" className="text-gray-600 hover:text-blue-600" onClick={(e) => scrollToSection('about', e)}>
                                    Tentang Kami
                                </a>
                            </li>
                        </ul>
